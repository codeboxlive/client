...
import { IGetTeamsPinnedProjectsBody, IJoin, IProject, IUserProjectsResponse, JoinType } from "@/models";
import { JOIN_COLLECTION_ID, PROJECTS_COLLECTION_ID } from "@/constants";
import moment from "moment";

export async function getTeamsPinnedProjects(body: IGetTeamsPinnedProjectsBody): Promise<IUserProjectsResponse> {
